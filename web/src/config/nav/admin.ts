...
export const adminNavItems: NavItem[] = [
  {
    ...
    subItems: [
      { label: 'Overview', href: '/dashboard', icon: Vault, exact: true, dashboardSeverity: { kind: 'overall' } },
      { label: 'Runtime', href: '/dashboard/runtime', icon: Sliders, dashboardSeverity: { kind: 'section', sectionId: 'runtime' } },
      { label: 'Filesystem', href: '/dashboard/filesystem', icon: VaultShield, dashboardSeverity: { kind: 'section', sectionId: 'filesystem' } },
      { label: 'Storage', href: '/dashboard/storage', icon: Vault, dashboardSeverity: { kind: 'section', sectionId: 'storage' } },
      { label: 'Operations', href: '/dashboard/operations', icon: ShareNodes, dashboardSeverity: { kind: 'section', sectionId: 'operations' } },
      { label: 'Trends', href: '/dashboard/trends', icon: UserShield, dashboardSeverity: { kind: 'section', sectionId: 'trends' } },
    ],
  },
