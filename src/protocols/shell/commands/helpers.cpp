...
std::shared_ptr<CommandUsage> vh::shell::resolveUsage(const std::vector<std::string>& path) {
...
void vh::shell::validatePositionals(const CommandCall& call, const std::shared_ptr<CommandUsage>& usage) {
