...
using namespace vh::storage::stats;
...
toTop10Array(const std::vector<vh::fs::model::stats::Extension>& v) {
...
void vh::storage::stats::to_json(nlohmann::json& j, const std::shared_ptr<Capacity>& stats) {
